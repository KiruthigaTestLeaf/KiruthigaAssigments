...
public class DeleteLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String FirstLead_id = driver.findElement(By.linkText("10020")).getText();
		System.out.println("The 1st Lead id is : " +FirstLead_id);
		
		driver.findElement(By.linkText("10020")).click();
		driver.findElement(By.linkText("Delete")).click();
		System.out.println("The first lead got deleted");
		
		driver.findElement(By.linkText("Find Leads")).click();
		driver.findElement(By.id("ext-gen246")).sendKeys("10020");
